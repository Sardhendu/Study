...
class Controller(object):
    ...
    def __init__(self):
        ...
        for ip, port in self.solvers:
            a = Popen(["python", "server_solver_simplified.py", str(port)]).pid
            self.pids.append(a)
    ...
    def connect(self):
        ...
        connections = []
        for address, port in self.solvers:   # The first attempt will always be false as self.connected is false, Once the connection is stored using storeConnections, the self.connected becomes true
